...
public class FriendRequestRVAdapter extends RecyclerView.Adapter<FriendRequestRVAdapter.MyViewHolder> {
    ...
    private static String ACCEPT_URL = "https://tarcomm.000webhostapp.com/acceptFriendRequest.php";
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        viewHolder.btnAcceptFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    updateFriendRequest(mContext,ACCEPT_URL,friendList.get(viewHolder.getAdapterPosition()));
