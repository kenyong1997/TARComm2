...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyDRSuYdn9yoCACUGxd4qGkgl59276mWvcs";
    ...
    // create the url to create JSON request
    ...
    //get the JSON response in JSONArray
